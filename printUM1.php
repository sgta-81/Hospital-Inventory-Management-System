...
<!-- <div class="container">
                <div class="row">
                    <div class="col">
                        <div class="text-right"></div><button onclick="location.href = 'formHis_um.php';" class="btn btn-success text-center" style = "background-color:black" type="submit" name="back1">Go Back</button></div>
                </div>
</div> -->
